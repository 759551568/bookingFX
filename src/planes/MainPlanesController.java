 ...
 * @author dan
 */
public class MainPlanesController implements Initializable {
    ...
    private void showInfo(MouseEvent event) {
        try {
            ...
            Logger.getLogger(MainPlanesController.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void showBookingNode(MouseEvent event) {
        switchScene("/planes/Book.fxml");
    }

    @FXML
    private void showDetailsNode(MouseEvent event) {
        switchScene("/planes/Details.fxml");
    }

    @FXML
    private void showListsNode(MouseEvent event) {
        switchScene("/planes/BookLists.fxml");
    }
