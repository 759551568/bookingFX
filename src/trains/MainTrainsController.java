 ...
 * @author dan
 */
public class MainTrainsController implements Initializable {
    ...
    private void showInfo(MouseEvent event) {
        try {
            ...
            Logger.getLogger(MainTrainsController.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void showBookingNode(MouseEvent event) {
        switchScene("/trains/Book.fxml");
    }

    @FXML
    private void showDetailsNode(MouseEvent event) {
        switchScene("/trains/Details.fxml");
    }

    @FXML
    private void showListsNode(MouseEvent event) {
        switchScene("/trains/BookLists.fxml");
    }
